...
public class TestViewZooJdbcConfig {
    ...
    public void testExplicitPropertyMappings() {
        Map<String, String> properties = ImmutableMap.<String, String>builder()
                .put("viewzoo.jdbc_url", "jdbc:postgresql://localhost:5432/viewzoo")
                .put("viewzoo.jdbc_user", "admin")
                .put("viewzoo.jdbc_password", "secret")
                .build();

        ViewZooJdbcConfig expected = new ViewZooJdbcConfig()
                .setJdbcUrl("jdbc:postgresql://localhost:5432/viewzoo")
